...
class SpamFilter_PanelSupport_Plesk
{
    ...
    public function bulkProtect($params)
    {
        ...
        // if extra domains are not used as aliases they should behave like normal domains
        // @see https://trac.spamexperts.com/ticket/25024#comment:31
        if (0 < $this->_config->handle_extra_domains && //process extra domains
            0 == $this->_config->add_extra_alias // not add as alias
        ) {
            $params['type'] = 'domain';
        }

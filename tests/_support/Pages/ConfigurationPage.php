...
class ConfigurationPage
{
    ...
    const PROCESS_ADDON_OPT           = "//input[@data-original-title='Process addon- and parked domains']";

    const ADD_ADDON_OPT               = "//input[@data-original-title='Add addon- and parked domains as an alias instead of a normal domain.']";

...
class ConfigurationPage
{
    ...
    const PROCESS_ADDON_OPT           = "//input[@data-original-title='Process aliases and sub-domains']";

    const ADD_ADDON_OPT               = "//input[@data-original-title='Add aliases and sub-domains as an alias instead of a normal domain.']";
